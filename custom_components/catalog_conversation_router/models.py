...
class ResolutionTrace:
    ...
    fuzzy_decision: dict[str, Any] | None = None
    fuzzy_local_outcome: str | None = None
    fuzzy_local_response_text: str | None = None
    fuzzy_local_response_type: str | None = None
    ...
    llm_fallback_needs_tools: bool | None = None
